...
<div id="div_hdr_path">&nbsp;Inicio &gt; Lineamientos &gt; Formato para la ponencia</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" border="0" align="center">
    <tr>
      <td><h1 class="H_Estilo1 margin_both">Formato para la ponencia</h1></td>
    </tr>
    <tr>
      <td><h3 class="H_Estilo2 margin_none"> Formato oficial para ponencias</h3>
        <p>Utilice el siguiente enlace para descargar el <em>Formato  para ponencia</em>, el cual debe llenar y subir de nuevo a esta pagina utilizando el formulario que se encuentra mas abajo.</p>
      ...
      <p class="margin_both"><a href="../adjuntos/formato_para_ponencia_p12.docx" class="estilo3"><img src="../imagenes/icono_docx.png" style="width:20px;" alt="Documento de Microsoft Word">&nbsp;Formato para ponencia</a></p></td>
    </tr>
    <tr>
      <td><table width="100%">
        <tr>
        ...
        <table width="100%" border="0">
          <tr>
          <td colspan="2"><h3 class="H_Estilo2">Formatos de archivo aceptados:</h3></td>
          </tr>
        <tr>
        ...
        <tr>
          <td align="right">-</td>
          <td> Archivo de Microsoft Word  en version 2010 o posterior (DOCX)</td>
        </tr>
        <tr>
          <td align="right">-</td>
...
$files = glob("./ponencias/".$_SESSION['MM_Username'].".*");
...
if ($num_files > 0){
	...
	foreach($files as $nombre_archivo){
		...
		echo " <- <a href='del_ponencia.php?archivo=".$nombre_archivo."' class='estilo3'>Eliminar</a>";
	}
	echo "<br><br>Estatus: ".$row_rsUsuario['arch_pon_stat'];
	echo "<br>Comentario: ".$row_rsUsuario['comentario2'];
	echo "</td></tr>";
	echo "</table>";
	echo "</td></tr>";
}
...
?>
    ...
    <tr>
      <td><form action="upload_form.php" method="post" enctype="multipart/form-data" name="form1">
      	<table width="100%" border="0">
      	  <tr>
