...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE usuarios SET pres_pon_stat=%s, pres_pon_fecha=%s, pres_pon_validador=%s, comentario3=%s WHERE username=%s",
                       GetSQLValueString($_POST['fPresPonStat'], "text"),
                       GetSQLValueString($_POST['fPresPonFecha'], "date"),
                       GetSQLValueString($_POST['fPresPonValidador'], "text"),
  ...
  $updateGoTo = "val_presentaciones.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Lineamientos &gt; Presentaciones &gt; Ver presentaciones para validar</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Ver presentaciones para validar</h1></td>
    </tr>
    <tr>
      <td><table width="100%">
...
$files = glob("./presentaciones/".$colname_rsUsuario.".*");
    ...
    <tr>
      <td><form action="<?php echo $editFormAction; ?>" name="form1" method="POST"><div class="DivShadowMsgValidar">
        <table width="550" align="center" class="tabla_info_msg">
          <tr>
            <th colspan="2" align="left" scope="col">¿Qué desea hacer con esta presentación?</th>
          </tr>
          <tr>
          ...
          <tr>
            <td align="right"><label for="fPresPonStat">Estatus</label></td>
          ...
          <tr>
            <td align="right"><label for="fPresPonFecha">Fecha</label></td>
            <td><input name="fPresPonFecha" type="text" id="fPresPonFecha" value="<?php echo date("Y-m-d"); ?>" size="15" maxlength="10" readonly></td>
          </tr>
          <tr>
            <td align="right"><label for="fPresPonValidador">Validó</label></td>
            <td><input name="fPresPonValidador" type="text" id="fPresPonValidador" value="<?php echo $row_rsValidador['username']; ?>" size="10" maxlength="20" readonly>
              <?php echo " ".$row_rsValidador['nombres']." ".$row_rsValidador['ape_pat']." ".$row_rsValidador['ape_mat']; ?></td>
          </tr>
          <tr>
            <td align="right"><label for="fComentario3">Comentario</label></td>
            <td><input name="fComentario3" type="text" id="fComentario3" size="50" maxlength="100"></td>
          </tr>
          <tr>
            <td colspan="2" align="right"><input type="submit" name="button" id="button" value="Enviar">
              <a href="val_presentaciones.php" class="button-link">Cancelar</a></td>
          </tr>
        </table></div>
