...
<div class="slideshow-container">
  <div class="mySlides fade">
    ...
    <img src="imagenes/banner_01.jpg" style="width:100%">
    <div class="text">Ejes tematicos</div>
  </div>
  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="imagenes/banner_02.jpg" style="width:100%">
    <div class="text">Lugar y fecha</div>
  </div>
  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="imagenes/banner_03.jpg" style="width:100%">
    <div class="text">Conferencistas</div>
  </div>
...
function showSlides() {
  ...
  setTimeout(showSlides, 4000); // Change image every 33 seconds
}
</script>
          </td>
        </tr>
        <tr>
          <td>
<?php
// Incluimos el modulo que muestra las noticias en la pagina principal
include("inc_noticias.php");
?>
          </td>
        </tr>
        <tr>
    ...
    <td width="250" align="center" valign="top"><table width="100%">
      <tr>
        <td align="center"><a href="mensaje_del_director.php" class="estilo3"><img src="imagenes/perfiles/director.jpg" alt="Mensaje del director" style="width:100%" class="opaca img_borde1"><br>
          Mensaje del director</a></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
