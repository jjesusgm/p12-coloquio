...
<div id="div_hdr_path">&nbsp;Inicio &gt; Convocatoria</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" border="0" align="center">
    <tr>
      <td align="left"><h1 class="H_Estilo1">  7° Coloquio  de Investigación Educativa en Prepa 12</h1></td>
    </tr>
    <tr>
      <td align="left"><img src="../imagenes/p12_cartel_7_coloquio_de_investigacion_educativa.jpg" alt="Cartel del 1er Coloquio de Investigación Educativa" style="max-width:100%" class="img_borde1"></td>
    </tr>
    <tr>
      <td align="left" valign="middle">&nbsp;</td>
    </tr>
    <tr>
      <td align="left" valign="middle"><h3 class="H_Estilo2">Descargas disponibles:</h3></td>
    </tr>
    <tr>
      <td align="left" valign="middle">&nbsp;&nbsp;&nbsp;<a href="../adjuntos/p12_convocatoria_7_coloquio_de_investigacion_educativa.pdf" target="_blank" class="estilo3"><img src="../imagenes/icono_pdf.png" alt="Icono PDF" width="20" height="20" class="opaca">&nbsp;Convocatoria</a></td>
    </tr>
    <tr>
      <td align="left" valign="middle">&nbsp;</td>
    </tr>
