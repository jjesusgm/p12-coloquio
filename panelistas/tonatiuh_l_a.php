...
<div id="div_hdr_path">&nbsp;Inicio &gt; Panelistas &gt; Israel Tonatiuh Lay Arellano</div>
  ...
  <table width="90%" align="center">
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="20%" align="left" valign="top"><img src="imagenes/tonatiuh_l_a.png" alt="Israel Tonatiuh Lay Arellano" style="width:90%; max-width:150px" class="img_borde1"></td>
          <td><strong>Nombre:</strong> Israel Tonatiuh Lay Arellano<br>
            <strong>Correo electrónico:</strong>
            <p class="justificado">Doctor en Ciencias Sociales por la Universidad de Guadalajara, Profesor-investigador Titular A en el Instituto de Gestión del Conocimiento y Aprendizaje en Ambientes Virtuales. Líneas de investigación: Legislación de medios, sociedad civil, poderes fácticos, redes sociales virtuales y Legislación y políticas públicas para el autismo. Autor del libro “Legislación de medios y poderes fácticos en México 2000-2012” (UDGVirtual, 2012), Coordinador de los libros “Caminando juntos, historias de familias que tienen hijos con autismo” (Ave editorial, 2015) y “Políticas públicas, intervención y tecnología. Enfoques multidisciplinarios de atención a la Condición del Espectro Autista” (Universidad de Guadalajara, 2016). Miembro del Sistema Nacional de investigadores Nivel I. Miembro de la Asociación Mexicana de Derecho a la Información (Amedi), Capítulo Jalisco. Director de Investigaciones de Iluminemos de Azul, A.C.</p></td>
        </tr>
      </table></td>
    </tr>
    <tr>
