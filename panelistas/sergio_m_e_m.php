...
<div id="div_hdr_path">&nbsp;Inicio &gt; Panelistas &gt; Sergio Mariano Estrada Muñiz</div>
  ...
  <table width="90%" align="center">
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="20%" align="left" valign="top"><img src="imagenes/sergio_m_e_m.png" alt="Sergio Mariano Estrada Muñiz" style="width:90%;max-width:150px" class="img_borde1"></td>
          <td><strong>Nombre:</strong> Sergio Mariano Estrada Muñiz<br>
            <strong>Correo electrónico:</strong>
            <p class="justificado">Abogado por la Facultad de Derecho de la Universidad de Guadalajara. Maestrante en Derecho con especialidad en derecho constitucional y amparo por la Universidad de Guadalajara. Diplomado en Derechos Humanos y sus Reformas Constitucionales. Diplomado en Sistema Penal Acusatorio con orientación en Derechos Humanos por la Universidad de Guadalajara para la certificación de SETEC de la Secretaria de Gobernación.</p>
            <p class="justificado">Certificado como docente en materia de derechos Humanos por el Comité de Capacitación del Consejo de Coordinación para la Implementación del Sistema de Justicia Penal de la Secretaría Técnica de la Secretaría de Gobernación. Seminario sobre el Sistema Interamericano de Derechos Humanos, coordinado por la Comisión Nacional de los Derechos Humanos. Diplomado de Competencias Docentes en el Nivel Medio Superior</p>
            <p class="justificado">Laboró como visitador adjunto de la Comisión Estatal de Derechos Humanos de Jalisco, en donde se ha desempeñado en distintas encomiendas, como la de Coordinador de Oficinas Regionales; Coordinador del Área Penitenciaria. Además fue comisionado en el Instituto de Investigación y Capacitación en Derechos Humanos del mismo organismo, como Investigador y Capacitador.</p>
            <p class="justificado">Ha participado como ponente y conferencista en diversos diplomados, cursos, talleres, simposios y otras exposiciones, con distintos temas de los que destacan, los derechos humanos, seguridad pública, equidad y género, grupos vulnerables, tortura, el servicio público, derechos a la salud, constitucionalismo, sistema penal acusatorio, sistema internacional de derechos humanos, planeación y estrategias en procuración de justicia, sistemas penitenciarios, deontología policial, derechos humanos y procuración de justicia, globalización de la delincuencia, marco jurídico policial, derechos humanos y procuración de justicia, entre otros temas más, relativos a los derechos humanos.</p></td>
        </tr>
      </table></td>
    </tr>
    <tr>
