...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE noticias SET imagen=%s WHERE id_noticia=%s",
                       "'".$_POST['fImagen']."'",
...
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Cambiar foto de noticia</h1></td>
    </tr>
    <tr>
        ...
        <div class="DivShadowMsg">
          <table width="800" class="tabla_info_msg">
            ...
            <tr>
              ...
              <td><input name="fIdNoticia" type="text" id="fIdNoticia" value="<?php echo $row_rsNoticia['id_noticia']; ?>" size="20" maxlength="10" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fIdAutor">Autor</label></td>
              <td><input name="fIdAutor" type="text" id="fIdAutor" value="<?php echo $row_rsNoticia['id_autor']; ?>" size="20" maxlength="20" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fFecha">Fecha</label></td>
              <td><input name="fFecha" type="text" id="fFecha" value="<?php echo $row_rsNoticia['fecha']; ?>" size="20" maxlength="20" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fEstatus3">Estatus</label></td>
              <td><input name="fEstatus" type="text" id="fEstatus2" value="<?php echo $row_rsNoticia['estatus']; ?>" size="20" maxlength="15" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="uploadedFile">Foto</label></td>
              <td><input name="uploadedFile" type="file" id="uploadedFile" size="60"></td>
            </tr>
            <tr>
              <td align="right" valign="top"><label for="fTitulo">Título</label></td>
              <td><textarea name="fTitulo" cols="85" rows="2" readonly id="fTitulo"><?php echo $row_rsNoticia['titulo']; ?></textarea></td>
            </tr>
            <tr>
              <td align="right" valign="top"><label for="fSubtitulo">Subtítulo</label></td>
              <td><textarea name="fSubtitulo" cols="85" rows="2" readonly id="fSubtitulo"><?php echo $row_rsNoticia['subtitulo']; ?></textarea></td>
            </tr>
            <tr>
              <td align="right" valign="top"><label for="fNoticia">Noticia</label></td>
              <td><textarea name="fNoticia" cols="85" rows="4" readonly id="fNoticia"><?php echo $row_rsNoticia['noticia']; ?></textarea></td>
            </tr>
            <tr>
