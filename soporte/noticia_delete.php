...
if ((isset($_POST['fIdNoticia'])) && ($_POST['fIdNoticia'] != "")) {
  $deleteSQL = sprintf("DELETE FROM noticias WHERE id_noticia=%s",
                       GetSQLValueString($_POST['fIdNoticia'], "int"));

  mysql_select_db($database_conColoquio, $conColoquio);
  $Result1 = mysql_query($deleteSQL, $conColoquio) or die(mysql_error());

  $deleteGoTo = "lst_noticias.php";
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Soporte &gt; Noticias &gt; Eliminar noticia</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Eliminar una noticia</h1></td>
    </tr>
    <tr>
      <td><form name="form1" method="post" action="">
        <div class="DivShadowMsg">
          <table width="800" align="center" class="tabla_warn_msg">
            <tr>
              <th colspan="4" align="left" scope="col">¿Desea eliminar esta noticia?</th>
              </tr>
            
            <tr>
              <td rowspan="5" align="center"><img src="../imagenes/warning.png" width="128" height="128" alt="Advertencia"></td>
              <td rowspan="-4" align="right"><label for="fIdNoticia2">ID</label></td>
              <td rowspan="-4"><input name="fIdNoticia" type="text" id="fIdNoticia" value="<?php echo $row_rsNoticia['id_noticia']; ?>" size="10" maxlength="10" readonly></td>
            </tr>
            <tr>
              <td rowspan="-4" align="right"><label for="fIdAutor">Autor</label></td>
              <td rowspan="-4"><input name="fIdAutor" type="text" id="fIdAutor" value="<?php echo $row_rsNoticia['id_autor']; ?>" size="20" maxlength="20" readonly></td>
            </tr>
            <tr>
              <td rowspan="-4" align="right"><label for="fFecha">Fecha</label></td>
              <td rowspan="-4"><input name="fFecha" type="text" id="fFecha" value="<?php echo $row_rsNoticia['fecha']; ?>" size="25" maxlength="25" readonly></td>
            </tr>
            <tr>
              <td rowspan="-4" align="right"><label for="fEstatus">Estatus</label></td>
              <td rowspan="-4"><input name="fEstatus" type="text" id="fEstatus" value="<?php echo $row_rsNoticia['estatus']; ?>" size="15" maxlength="15" readonly></td>
            </tr>
            
            
            <tr>
              <td align="right"><label for="fResumen">Resumen </label></td>
              <td><input name="fResumen" type="text" id="fResumen" value="<?php echo $row_rsNoticia['titulo']; ?>" size="70" maxlength="100" readonly></td>
            </tr>
            <tr>
              <td colspan="3" align="right"><input type="submit" name="fAceptar" id="fAceptar" value="Enviar">
