...
<div id="div_contenido">
  <table width="90%" border="0" align="center">
    <tr>
      <td><h1 class="H_Estilo1 margin_both">Opciones de soporte</h1></td>
    </tr>
    <tr>
      <td><table width="100%">
        <tr>
          <td width="40" align="right">-</td>
          <td><a href="lst_noticias.php" class="estilo3">Administrar noticias</a></td>
        </tr>
        <tr>
          <td align="right">-</td>
          <td><a href="contacto.php" class="estilo3">Administrar mensajes de contacto</a></td>
        </tr>
        <tr>
          <td align="right">-</td>
          <td><a href="lista_usuarios.php" class="estilo3">Ver lista completa de usuarios</a></td>
        </tr>
        <tr>
          <td align="right">-</td>
          <td><a href="ver_archivos.php" class="estilo3">Ver lista de archivos (pagos, ponencias, presentaciones)</a></td>
        </tr>
      </table></td>
    </tr>
    <tr>
