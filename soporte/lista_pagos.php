...
<link href="../css/manejo_archivos.css" rel="stylesheet" type="text/css" />
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Soporte &gt; Ver archivos &gt; Comprobantes de pago</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1 margin_both">Ver comprobantes de pago</h1></td>
    </tr>
    <tr>
      <td>
<?php
...
if ($num_files > 0){
	...
	foreach($files as $nombre_archivo){
		echo "<br>&nbsp;&nbsp;&nbsp;- <a href='".$nombre_archivo."' target='_blank' class='estilo3'>".basename($nombre_archivo)."</a>";
	}
	echo "</td></tr>";
	echo "</table>";
}else{
