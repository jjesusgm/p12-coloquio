...
$query_rsNoticias = "SELECT * FROM noticias ORDER BY fecha DESC";
$query_limit_rsNoticias = sprintf("%s LIMIT %d, %d", $query_rsNoticias, $startRow_rsNoticias, $maxRows_rsNoticias);
$rsNoticias = mysql_query($query_limit_rsNoticias, $conColoquio) or die(mysql_error());
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Soporte &gt; Administrar noticias</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Administrar noticias</h1></td>
    </tr>
    <?php if ($totalRows_rsNoticias == 0) { // Show if recordset empty ?>
      <tr>
        <td><h2 class="H_Estilo2">No hay noticias para mostrar</h2></td>
      </tr>
      <?php } // Show if recordset empty ?>
    <?php if ($totalRows_rsNoticias > 0) { // Show if recordset not empty ?>
  <tr>
    <td align="center"><h2 class="H_Estilo2">Mostrando noticias <?php echo ($startRow_rsNoticias + 1) ?> al <?php echo min($startRow_rsNoticias + $maxRows_rsNoticias, $totalRows_rsNoticias) ?> de <?php echo $totalRows_rsNoticias ?></h2></td>
  </tr>
      <tr>
        <td align="center"><h3 class="estilo3 margin_both"><a href="noticia_add.php" class="estilo3">Agregar nueva noticia</a></h3></td>
      </tr>
      <tr>
        <td align="center"><table width="100%" class="TablaListaInventario">
          ...
          <?php do { ?>
            <tr>
              <td align="center"><?php echo $row_rsNoticias['id_noticia']; ?></td>
              <td align="center"><?php echo $row_rsNoticias['id_autor']; ?></td>
              <td align="center"><?php echo $row_rsNoticias['fecha']; ?></td>
              <td align="center"><?php echo $row_rsNoticias['estatus']; ?></td>
              <td><?php echo $row_rsNoticias['titulo']; ?></td>
              <td align="center"><a href="noticia_edit.php?id_noticia=<?php echo $row_rsNoticias['id_noticia']; ?>" class="estilo3">Editar</a> | <a href="noticia_delete.php?id_noticia=<?php echo $row_rsNoticias['id_noticia']; ?>" class="estilo3">Eliminar</a><br><a href="noticia_cambia_foto.php?id_noticia=<?php echo $row_rsNoticias['id_noticia']; ?>" class="estilo3">Cambiar foto</a></td>
            </tr>
      ...
      <tr>
        <td align="center"><h3 class="margin_both"><a href="noticia_add.php" class="estilo3">Agregar nueva noticia</a></h3></td>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
      </tr>
