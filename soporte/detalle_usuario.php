...
<div id="div_hdr_path">&nbsp;Inicio &gt; Soporte &gt; Lista usuarios &gt; Ver detalle</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" border="0" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Ver detalles del  usuario</h1></td>
    </tr>
    <tr>
        ...
        <div class="DivShadowMsg">
          <table width="800" border="0" align="center" class="tabla_info_msg">
            ...
            <tr>
              ...
              <td><input name="fNivelDeAcceso2" type="text" id="fNivelDeAcceso2" value="<?php echo $row_rsUsuario['nivel_de_acceso']; ?>" readonly>
                <input name="fCicloDeIngreso" type="hidden" id="fCicloDeIngreso" value="2019"></td>
            </tr>
            <tr>
              <td align="right"><label for="fEmail">e-mail</label></td>
              <td><input name="fEmail" type="text" id="fEmail" Pattern="([a-z0-9_\.-]+)@([\da-z\.-]+)\.([a-z\.]{2,6})" value="<?php echo $row_rsUsuario['email']; ?>" size="50" maxlength="100" readonly><span class="validity"></span></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input name="fNombres" type="text" required id="fNombres" value="<?php echo $row_rsUsuario['nombres']; ?>" size="30" maxlength="30" readonly><span class="validity"></span></td>
            </tr>
            <tr>
              <td align="right"><label for="fApePat">Apellido paterno</label></td>
              <td><input name="fApePat" type="text" required id="fApePat" value="<?php echo $row_rsUsuario['ape_pat']; ?>" size="30" maxlength="30" readonly><span class="validity"></span></td>
            </tr>
            <tr>
              <td align="right"><label for="fApeMat">Apellido materno</label></td>
              <td><input name="fApeMat" type="text" id="fApeMat" value="<?php echo $row_rsUsuario['ape_mat']; ?>" size="30" maxlength="30" readonly><span class="validity"></span></td>
            </tr>
            <tr>
              <td align="right"><label for="fSexo">Sexo</label></td>
              <td>
                <input name="fSexo" type="text" id="fSexo" value="<?php echo $row_rsUsuario['sexo']; ?>" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fFechaNacimiento">Fecha nacimiento</label></td>
              <td><input name="fFechaNacimiento" type="text" required id="fFechaNacimiento" value="<?php echo $row_rsUsuario['fecha_nacimiento']; ?>" size="15" maxlength="10" readonly></td>
            </tr>
            <tr>
...
?>
            ...
            <tr id="fUnivOtra">
              ...
              <td><input name="fUnivOtra" type="text" id="fUnivOtra" value="<?php echo $row_rsUsuario['univ_otra']; ?>" size="50" maxlength="100" readonly></td>
            </tr>
            <tr>
...
?>
            ...
            <tr id="fGradoAcadOtro">
              ...
              <td><input name="fGradoAcadOtro" type="text" id="fGradoAcadOtro" value="<?php echo $row_rsUsuario['grado_acad_otro']; ?>" size="20" maxlength="30" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fNumCelular">Celular</label></td>
              <td><input name="fNumCelular" type="text" id="fNumCelular" value="<?php echo $row_rsUsuario['num_celular']; ?>" size="15" maxlength="15" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fCompPagoStat">Estatus pago</label></td>
              <td><input name="fCompPagoStat" type="text" id="fCompPagoStat" value="<?php echo $row_rsUsuario['comp_pago_stat']; ?>"></td>
            </tr>
            <tr>
              <td align="right"><label for="fCompPagoFecha">Fecha estatus pago</label></td>
              <td><input name="fCompPagoFecha" type="text" id="fCompPagoFecha" value="<?php echo $row_rsUsuario['comp_pago_fecha']; ?>" size="15" maxlength="10" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fComentario3">Comentario 1</label></td>
              <td><input name="fComentario1" type="text" id="fComentario1" value="<?php echo $row_rsUsuario['comentario1']; ?>" size="50" maxlength="50" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fArchPonStat">Estatus entrega ponencia</label></td>
              <td><input name="fArchPonStat" type="text" id="fArchPonStat" value="<?php echo $row_rsUsuario['arch_pon_stat']; ?>" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fArchPonFecha">Fecha estatus ponencia</label></td>
              <td><input name="fArchPonFecha" type="text" id="fArchPonFecha" value="<?php echo $row_rsUsuario['arch_pon_fecha']; ?>" size="15" maxlength="10" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fComentario4">Comentario 2</label></td>
              <td><input name="fComentario2" type="text" id="fComentario2" value="<?php echo $row_rsUsuario['comentario2']; ?>" size="50" maxlength="50" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fPresPonStat">Estatus presentación ponencia</label></td>
              <td><input name="fPresPonStat" type="text" id="fPresPonStat" value="<?php echo $row_rsUsuario['pres_pon_stat']; ?>" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fPresPonFecha">Fecha estatus presentación</label></td>
              <td><input name="fPresPonFecha" type="text" id="fPresPonFecha" value="<?php echo $row_rsUsuario['pres_pon_fecha']; ?>" size="15" maxlength="10" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fComentario5">Comentario 3</label></td>
              <td><span class="validity">
                <input name="fComentario3" type="text" id="fComentario3" value="<?php echo $row_rsUsuario['comentario3']; ?>" size="50" maxlength="50" readonly>
              </span></td>
            </tr>
            <tr>
              <td height="35" colspan="2" align="right"><a href="lista_usuarios.php" class="button-link">Regresar a la página anterior</a>&nbsp;</td>
            </tr>
          </table>
        </div>
      </form></td>
