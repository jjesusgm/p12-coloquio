...
if (isset($_POST['fUsuario'])) {
  ...
  $LoginRS = mysql_query($LoginRS__query, $conColoquio) or die(mysql_error());
  ...
  <div class="DivShadowMsgLogin">
    <table width="350" align="center" class="tabla_info_msg">
      ...
      <tr>
        ...
        <td><input name="fUsuario" type="text" id="fUsuario" size="20" maxlength="20" required pattern=".{1,}" title="Escribe tu nombre de usuario" /><span class="validity"></span></td>
      </tr>
      <tr>
        <td align="right"><label for="fPassword">Contraseña*</label></td>
        <td><input name="fPassword" type="password" id="fPassword" size="20" maxlength="20" required pattern=".{1,}" title="Escribe tu contraseña" /><span class="validity"></span></td>
      </tr>
      <tr>
