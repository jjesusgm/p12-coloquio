...
<div id="div_hdr_path">&nbsp;Inicio &gt; Hospedaje</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" border="0" align="center">
    <tr>
      <td align="left"><h1 class="H_Estilo1">Hospedaje recomendado</h1></td>
    </tr>
    <tr>
      <td align="left"><table class="TBL_MsgWarning">
        <tr>
          <th scope="row">&nbsp;</th>
          <td>Los precios son aproximados y actualizados al 19 de Julio de 2019</td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td align="left"><h2 class="H_Estilo2">Zona Centro de Guadalajara</h2>
        <p><strong>Hotel Aranzazu</strong><br>
          <a href="http://aranzazu.com.mx/centrohistorico" target="_blank">http://aranzazu.com.mx/centrohistorico</a><br>
          Av. Revolución 110, Zona Centro<br>
          Tel: 013339424024<br>
          Tarifa: $ 1,094.00  Habitación doble</p>
        <p><strong>Hotel Morales Historical</strong><br>
          Av. Ramón Corona 243, Centro Histórico<br>
          Tel: 01 33 36585232<br>
          Tarifa: $ 1,456.00 Habitación doble</p>
        <p><strong>Hotel Roma Guadalajara</strong><br>
          Av. Juárez 170, Zona Centro<br>
          Tel: 01 33 36142629<br>
          Tarifa: $ 1,229.00 Habitación doble</p>
        <p><strong>Hotel Real Maestranza</strong><br>
          Francisco y Madero 161, Zona Centro<br>
          Tel: 01 33 36136101<br>
          Tarifa: $ 1,039 Habitación doble</p>
        <p><strong>Hotel Don Quijote Plaza</strong><br>
          Héroes de la Independencia  91, Zona Centro<br>
          Tel: 01 33 36581299<br>
          Tarifa $ 879.00 Habitación doble</p>
        <h2 class="H_Estilo2">San Pedro Tlaquepaque</h2>
        <p><strong>Hotel Puerta San Pedro</strong><br>
          Calle Carrillo Puerto 212, San Pedro Tlaquepaque<br>
          Tel: 01 33 16539333<br>
          Tarifa: 1$ 1,100.00 Habitación doble</p>
        <p><strong>Hotel Aquiles </strong><br>
          Aquiles Serdan 152, San Pedro Tlaquepaque<br>
          Tel: 01 33 36175086<br>
      Tarifa: $ 1,148.00 Habitación doble</p></td>
    </tr>
    <tr>
      <td align="left">&nbsp;</td>
    </tr>
