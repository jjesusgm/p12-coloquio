...
<div id="div_hdr_path">&nbsp;Inicio &gt; Sala de prensa</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Noticias</h1></td>
    </tr>
    <tr>
      <td><?php do { ?>
          <table class="TBL_NotiTodas">
            <tr>
              <th width="10%" rowspan="3" valign="top" scope="col">
<?php 
if($row_rsNoticias['imagen'] == NULL){
  echo "<img src='imagenes/ico_noticia.jpg' style='width:120px;' />";
}else{
  echo "<img src='data:image/jpeg;base64,".base64_encode($row_rsNoticias['imagen'])."' style='width:120px;' />";
}
?>
			  </th>
              <th align="left" scope="col"><?php echo $row_rsNoticias['titulo']; ?></th>
            </tr>
            <tr>
              <td><?php echo $row_rsNoticias['fecha']; ?></td>
            </tr>
            <tr>
              <td><?php echo $row_rsNoticias['noticia']; ?></td>
            </tr>
            <tr>
