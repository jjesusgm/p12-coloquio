...
<div id="div_hdr_path">&nbsp;Inicio &gt; Noticias &gt; Ver noticia</div>
...
<div id="div_contenido">
  <table width="90%" align="center">
    ...
    <tr>
      <td><table width="100%">
        <tr>
          <td width="250" align="center" valign="top"><?php 
if($row_rsNoticia['imagen'] == NULL){
  echo "<img src='imagenes/ico_noticia.jpg' style='width:250px;' />";
}else{
  echo "<img src='data:image/jpeg;base64,".base64_encode($row_rsNoticia['imagen'])."' style='width:250px;' />";
}
?></td>
          <td align="right"><table width="95%">
            <tr>
              <td align="center"><h2 class="H_Estilo1 margin_none"><?php echo $row_rsNoticia['titulo']; ?></h2></td>
              </tr>
            <tr>
              <td align="center"><h4 class="H_Estilo2 margin_both"><?php echo $row_rsNoticia['subtitulo']; ?></h4></td>
              </tr>
            <tr>
              <td><?php echo $row_rsNoticia['noticia']; ?></td>
              </tr>
            <tr>
              <td align="right"><?php echo $row_rsNoticia['fecha']; ?><br>
                <?php echo $row_rsNoticia['id_autor']; ?></td>
              </tr>
            </table></td>
        </tr>
      </table></td>
