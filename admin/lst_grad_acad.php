...
$maxRows_rsGradosAcademicos = 100;
$pageNum_rsGradosAcademicos = 0;
if (isset($_GET['pageNum_rsGradosAcademicos'])) {
  $pageNum_rsGradosAcademicos = $_GET['pageNum_rsGradosAcademicos'];
}
$startRow_rsGradosAcademicos = $pageNum_rsGradosAcademicos * $maxRows_rsGradosAcademicos;
...
$query_limit_rsGradosAcademicos = sprintf("%s LIMIT %d, %d", $query_rsGradosAcademicos, $startRow_rsGradosAcademicos, $maxRows_rsGradosAcademicos);
$rsGradosAcademicos = mysql_query($query_limit_rsGradosAcademicos, $conColoquio) or die(mysql_error());
$row_rsGradosAcademicos = mysql_fetch_assoc($rsGradosAcademicos);

if (isset($_GET['totalRows_rsGradosAcademicos'])) {
  $totalRows_rsGradosAcademicos = $_GET['totalRows_rsGradosAcademicos'];
} else {
  $all_rsGradosAcademicos = mysql_query($query_rsGradosAcademicos);
  $totalRows_rsGradosAcademicos = mysql_num_rows($all_rsGradosAcademicos);
}
$totalPages_rsGradosAcademicos = ceil($totalRows_rsGradosAcademicos/$maxRows_rsGradosAcademicos)-1;
?>
<!DOCTYPE html>
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Administrador &gt; Grados académicos</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" border="0" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Administrar grados académicos</h1></td>
    </tr>
    <?php if ($totalRows_rsGradosAcademicos == 0) { // Show if recordset empty ?>
      <tr>
        <td align="left"><h2 class="H_Estilo2">No hay grados académicos para mostrar</h2></td>
      </tr>
      <?php } // Show if recordset empty ?>
    <?php if ($totalRows_rsGradosAcademicos > 0) { // Show if recordset not empty ?>
      <tr>
        <td align="center"><h2 class="H_Estilo2">Mostrando grados académicos <?php echo ($startRow_rsGradosAcademicos + 1) ?> al <?php echo min($startRow_rsGradosAcademicos + $maxRows_rsGradosAcademicos, $totalRows_rsGradosAcademicos) ?> de <?php echo $totalRows_rsGradosAcademicos ?></h2></td>
      </tr>
      <?php } // Show if recordset not empty ?>
<tr>
      <td align="center"><h3><a href="grad_acad_add.php" class="estilo3">Agregar nuevo grado académico</a></h3></td>
    </tr>
    <tr>
      <td align="center"><table width="500" class="TablaListaInventario">
        ...
        <?php do { ?>
          <tr>
            <td align="center"><?php echo $row_rsGradosAcademicos['id_grado_acad']; ?></td>
            <td align="center"><?php echo $row_rsGradosAcademicos['grado_academico']; ?></td>
            <td align="center"><a href="grad_acad_edit.php?ID=<?php echo $row_rsGradosAcademicos['id_grado_acad']; ?>" class="estilo3">Editar</a> | <a href="grad_acad_delete.php?ID=<?php echo $row_rsGradosAcademicos['id_grado_acad']; ?>">Eliminar</a></td>
          </tr>
          <?php } while ($row_rsGradosAcademicos = mysql_fetch_assoc($rsGradosAcademicos)); ?>
      </table></td>
    </tr>
    <tr>
      <td align="center"><h3><a href="grad_acad_add.php" class="estilo3">Agregar nuevo grado académico</a></h3></td>
