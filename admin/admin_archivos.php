...
<div id="div_hdr_path">&nbsp;Inicio &gt; Administrador &gt; Administrar archivos</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1 margin_both">Administrar archivos (pagos, ponencias, presentaciones)</h1></td>
    </tr>
    <tr>
      <td><table width="100%">
        <tr>
          <td width="25" align="right">-</td>
          <td><a href="lista_pagos.php" class="estilo3">Comprobantes de pago</a></td>
        </tr>
        <tr>
          <td width="25" align="right">-</td>
          <td><a href="lista_ponencias.php" class="estilo3">Archivos de ponencias</a></td>
        </tr>
        <tr>
          <td width="25" align="right">-</td>
          <td><a href="lista_presentaciones.php" class="estilo3">Presentaciones de ponencias</a></td>
        </tr>
        <tr>
          <td align="right">-</td>
          <td>Cartas de aceptación</td>
        </tr>
      </table></td>
    </tr>
    <tr>
