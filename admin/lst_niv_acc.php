...
$rsNivelesDeAcceso = mysql_query($query_limit_rsNivelesDeAcceso, $conColoquio) or die(mysql_error());
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Administrador &gt; Niveles de acceso</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" border="0" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Administrar niveles de acceso</h1></td>
    </tr>
    <?php if ($totalRows_rsNivelesDeAcceso == 0) { // Show if recordset empty ?>
      <tr>
        <td><h2 class="H_Estilo2">No hay niveles de acceso para mostrar</h2></td>
      </tr>
      <?php } // Show if recordset empty ?>
    <?php if ($totalRows_rsNivelesDeAcceso > 0) { // Show if recordset not empty ?>
      <tr>
        <td align="center"><h2 class="H_Estilo2">Mostrando niveles de acceso <?php echo ($startRow_rsNivelesDeAcceso + 1) ?> al <?php echo min($startRow_rsNivelesDeAcceso + $maxRows_rsNivelesDeAcceso, $totalRows_rsNivelesDeAcceso) ?> de <?php echo $totalRows_rsNivelesDeAcceso ?></h2></td>
      </tr>
      <?php } // Show if recordset not empty ?>
<tr>
      <td align="center"><h3><a href="niv_acc_add.php" class="estilo3">Agregar nuevo nivel de acceso</a></h3></td>
    </tr>
    <tr>
      <td align="center"><table width="500" class="TablaListaInventario">
        <tr>
          <th scope="col">ID</th>
        ...
        <?php do { ?>
          <tr>
            <td align="center"><?php echo $row_rsNivelesDeAcceso['id_nivel_acceso']; ?></td>
            <td align="center"><?php echo $row_rsNivelesDeAcceso['nivel_de_acceso']; ?></td>
            <td align="center"><a href="niv_acc_edit.php?ID=<?php echo $row_rsNivelesDeAcceso['id_nivel_acceso']; ?>" class="estilo3">Editar</a> | <a href="niv_acc_delete.php?ID=<?php echo $row_rsNivelesDeAcceso['id_nivel_acceso']; ?>" class="estilo3">Eliminar</a></td>
          </tr>
