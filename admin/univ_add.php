...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO list_universidades (universidad) VALUES (%s)",
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Administrador &gt; Agregar universidad</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Agregar universidad</h1></td>
    </tr>
    <tr>
        ...
        <div class="DivShadowMsgValidar">
          <table width="550" class="tabla_info_msg">
            ...
            <tr>
              ...
              <td><input name="fUniversidad" type="text" id="fUniversidad" size="50" maxlength="100" required><span class="validity"></span></td>
            </tr>
            <tr>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
