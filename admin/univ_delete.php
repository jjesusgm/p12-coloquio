...
if ((isset($_POST['fIdUniversidad'])) && ($_POST['fIdUniversidad'] != "")) {
  $deleteSQL = sprintf("DELETE FROM list_universidades WHERE id_universidad=%s",
...
$colname_rsUniversidad = "-1";
if (isset($_GET['id_universidad'])) {
  $colname_rsUniversidad = $_GET['id_universidad'];
}
mysql_select_db($database_conColoquio, $conColoquio);
$query_rsUniversidad = sprintf("SELECT * FROM list_universidades WHERE id_universidad = %s", GetSQLValueString($colname_rsUniversidad, "int"));
$rsUniversidad = mysql_query($query_rsUniversidad, $conColoquio) or die(mysql_error());
$row_rsUniversidad = mysql_fetch_assoc($rsUniversidad);
$totalRows_rsUniversidad = mysql_num_rows($rsUniversidad);
?>
<!DOCTYPE html>
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Administrador &gt; Eliminar universidad</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Eliminar universidad</h1></td>
    </tr>
    <tr>
      <td><form name="form1" method="post" action="">
        <div class="DivShadowMsg">
          <table width="800" class="tabla_warn_msg">
            <tr>
              <th colspan="3" align="left" scope="col">¿Está seguro de querer eliminar esta universidad?</th>
              </tr>
            <tr>
              <td rowspan="5" align="right"><img src="../imagenes/warning.png" width="128" height="128" alt="Advertencia"></td>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td align="right"><label for="fIdUniversidad2">ID</label></td>
              <td><input name="fIdUniversidad" type="text" id="fIdUniversidad" value="<?php echo $row_rsUniversidad['id_universidad']; ?>" size="15" maxlength="10" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fUniversidad">Nombre</label></td>
              <td><input name="fUniversidad" type="text" id="fUniversidad" value="<?php echo $row_rsUniversidad['universidad']; ?>" size="65" maxlength="100" readonly></td>
            </tr>
            <tr>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td align="right">&nbsp;</td>
              <td align="right">
                <input type="submit" name="bEliminar" id="bEliminar" value="Enviar">
                <a href="lst_univ.php" class="button-link">Cancelar</a>&nbsp;
              </td>
              </tr>
          </table>
        </div>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($rsUniversidad);
?>
