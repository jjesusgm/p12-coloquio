...
<div id="div_hdr_path">&nbsp;Inicio &gt; Administrador</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" border="0" align="center">
    <tr>
      <td width="30" scope="row"><h1 class="H_Estilo1">Opciones del administrador</h1></td>
    </tr>
    <tr>
      <td align="left" scope="row"><table width="100%">
        <tr>
          <td align="right">-</td>
          <td><a href="admin_archivos.php" class="estilo3">Administrar archivos</a></td>
        </tr>
        <tr>
          <td width="40" align="right">-</td>
          <td><a href="lst_grad_acad.php" class="estilo3">Administrar grados académicos</a></td>
        </tr>
        <tr>
          <td width="40" align="right">-</td>
          <td><a href="lst_niv_acc.php" class="estilo3">Administrar niveles de acceso</a></td>
        </tr>
        <tr>
          <td width="40" align="right">-</td>
          <td><a href="../soporte/lst_noticias.php" class="estilo3">Administrar noticias</a></td>
        </tr>
        <tr>
          <td width="40" align="right">-</td>
          <td><a href="lst_univ.php" class="estilo3">Administrar universidades</a></td>
        </tr>
        <tr>
          <td width="40" align="right">-</td>
          <td><a href="lst_usr.php" class="estilo3">Administrar usuarios</a></td>
        </tr>
      </table></td>
    </tr>
    <tr>
