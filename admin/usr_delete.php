...
if ((isset($_POST['fUsername'])) && ($_POST['fUsername'] != "")) {
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Administración &gt; Usuarios &gt; Eliminar</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" border="0" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Eliminar  usuario</h1></td>
    </tr>
    <tr>
      <td><form name="form1" method="post" action=""><div class="DivShadowMsg">
        <table width="800" border="0" align="center" class="tabla_warn_msg">
          <tr>
            <th colspan="3" align="left" scope="col">¿Esta seguro de querer eliminar este usuario?</th>
          </tr>
          <tr>
            <td rowspan="5" align="center"><img src="../imagenes/warning.png" alt="Eliminar usuario" width="128" height="128"></td>
            <td colspan="2">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="right"><label for="fNivelDeAcceso">Niv. acceso</label></td>
            <td><input name="fNivelDeAcceso" type="text" id="fNivelDeAcceso" value="<?php echo $row_rsUsuario['nivel_de_acceso']; ?>" size="15" maxlength="15" readonly></td>
          </tr>
          <tr>
            <td colspan="2" align="right"><input type="submit" name="bSi" id="bSi" value="&nbsp;&nbsp;&nbsp;Si&nbsp;&nbsp;&nbsp;">
              <a href="lst_usr.php" class="button-link">&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;&nbsp;</a></td>
            </tr>
        </table></div>
      </form></td>
    </tr>
