...
$query_rsUsuarios = sprintf("SELECT * FROM usuarios WHERE username LIKE %s AND nivel_de_acceso LIKE %s AND nombres LIKE %s AND ape_pat LIKE %s AND ape_mat LIKE %s ORDER BY ape_pat, ape_mat, nombres ASC", GetSQLValueString($q_username_rsUsuarios, "text"),GetSQLValueString($q_niv_acc_rsUsuarios, "text"),GetSQLValueString($q_nombres_rsUsuarios, "text"),GetSQLValueString($q_ape_pat_rsUsuarios, "text"),GetSQLValueString($q_ape_mat_rsUsuarios, "text"));
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Administrador &gt; Usuarios</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" border="0" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Administrar usuarios</h1></td>
    </tr>
    <tr>
...
?>
  ...
  <table width="100%">
  <tr><td align="center"><h3 class="margin_both"><a href="usr_add.php" class="estilo3">Agregar nuevo usuario</a></h3></td></tr>
  <tr>
  ...
  <tr>
    <td align="center"><table width="100%" border="0" class="TablaListaInventario">
      ...
      <tr>
        ...
        <td align="center"><a href="usr_edit.php?username=<?php echo $row_rsUsuarios['username']; ?>" class="estilo3">Editar</a> | <a href="usr_delete.php?username=<?php echo $row_rsUsuarios['username']; ?>" class="estilo3">Eliminar</a></td>
      </tr>
  ...
  <tr>
    <td align="center"><h3 class="margin_both"><a href="usr_add.php" class="estilo3">Agregar nuevo usuario</a></h3></td>
  </tr>
  </table>
</div>
<!-- InstanceEndEditable -->
