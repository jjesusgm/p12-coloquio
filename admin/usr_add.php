...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO usuarios (username, nip, nivel_de_acceso, ciclo_de_ingreso, email, ape_pat, ape_mat, nombres, sexo, fecha_nacimiento, id_universidad, univ_otra, id_grado_acad, grado_acad_otro, num_celular, comentario1, comentario2) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Administración &gt; Usuarios &gt; Agregar</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" border="0" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Agregar usuario</h1></td>
    </tr>
    <tr>
        ...
        <div class="DivShadowMsg">
          <table width="800" border="0" align="center" class="tabla_info_msg">
            ...
            <tr>
              ...
              <td><table class="TablaInvisible">
                <tr>
                    <td><input name="fUsername" type="text" id="fUsername" size="20" maxlength="20" autocomplete="off" pattern="[a-zA-Z0-9_-]{4,20}" required><span class="validity"></span></td>
            ...
            <tr>
              ...
              <td><input name="fNip" type="password" id="fNip" size="20" maxlength="100" pattern="[a-zA-Z0-9_-]{4,100}" required><span class="validity"></span>
...
?>
            ...
            <tr>
              ...
              <td><input name="fApePat" type="text" id="fApePat" size="30" maxlength="30" required><span class="validity"></span></td>
            </tr>
            <tr>
              <td align="right"><label for="fApeMat">Apellido materno</label></td>
              <td><input name="fApeMat" type="text" id="fApeMat" size="30" maxlength="30"><span class="validity"></span></td>
            </tr>
            <tr>
...
?>
            ...
            <tr id="fGradoAcadOtro" class="ElemOculto">
              ...
              <td><input name="fGradoAcadOtro" type="text" id="fGradoAcadOtro" size="20" maxlength="30"></td>
            </tr>
            <tr>
              <td align="right"><label for="fNumCelular">Celular*</label></td>
              <td><input name="fNumCelular" type="tel" id="fNumCelular" size="15" maxlength="15" pattern="[0-9]{10}" placeholder="Lada+Numero" required><span class="validity"></span></td>
            </tr>
            <tr>
              <td align="right"><label for="fComentario1">Comentario 1</label></td>
              <td><input name="fComentario1" type="text" id="fComentario1" size="50" maxlength="50"><span class="validity"></span></td>
            </tr>
            <tr>
              <td align="right"><label for="fComentario2">Comentario 2</label></td>
              <td><input name="fComentario2" type="text" id="fComentario2" size="50" maxlength="50"><span class="validity"></span></td>
            </tr>
            <tr>
