...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE list_universidades SET universidad=%s WHERE id_universidad=%s",
                       GetSQLValueString($_POST['fUniversidad'], "text"),
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Administrador &gt; Editar universidad</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Editar universidad</h1></td>
    </tr>
    <tr>
      <td><form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <div class="DivShadowMsgValidar">
          <table width="550" class="tabla_info_msg">
            <tr>
              <th colspan="2" align="left" scope="col">Datos de la universidad</th>
              </tr>
            <tr>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td align="right"><label for="fIdUniversidad">ID</label></td>
              <td><input name="fIdUniversidad" type="text" id="fIdUniversidad" value="<?php echo $row_rsUniversidad['id_universidad']; ?>" size="10" maxlength="10" readonly></td>
            </tr>
            <tr>
              <td align="right"><label for="fUniversidad">Nombre</label></td>
              <td><input name="fUniversidad" type="text" id="fUniversidad" value="<?php echo $row_rsUniversidad['universidad']; ?>" size="50" maxlength="100" required><span class="validity"></span></td>
            </tr>
            <tr>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td colspan="2" align="right"><input type="submit" name="button" id="button" value="Enviar">
                ...
                <a href="lst_univ.php" class="button-link">Cancelar</a>&nbsp;</td>
              </tr>
          </table>
        </div>
