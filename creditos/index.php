...
<div id="div_hdr_path">&nbsp;Inicio &gt; Créditos de sitio</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" border="0" align="center" class="TablaContenido">
    <tr>
      <td><h1 class="titulo">Créditos</h1>
        <h2>Escuela Preparatoria No. 12</h2>
        <ul>
          <li>Mtro. Rubén García Becerra<br>
            Director</li>
        </ul>
        <h3>Editores y colaboradores</h3>
        <ul>
          <li>Ing. José de Jesús Gutiérrez Martínez<br>
            Webmaster</li>
      </ul></td>
    </tr>
  </table>
