...
<div id="div_contenido">
  ...
  <table width="600" align="center" class="tabla_usuario">
    ...
    <tr>
      <td>Estas viendo este manseje porque no tienes permisos para ver esta página. Puedes ponerte en contacto con el administrador, hacer clic en alguna de las opciones del menú o iniciar sesión utilizando el siguiente enlace.</td>
    </tr>
    <tr align="right">
      <td colspan="2"><a href="login.php">Iniciar sesión</a></td>
    </tr>
  </table>
  <p>&nbsp;</p>
</div>
