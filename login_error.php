...
<div id="div_contenido">
  <p>&nbsp;</p>
  <table width="500" align="center" class="tabla_error">
    <tr>
      <th align="left" scope="col">Mensaje del sistema</th>
    </tr>
    <tr>
      <td align="center"><h3>Error de inicio de sesion: Nombre de usuario y/o Contraseña incorrecto(s)...</h3>
      <h5><a href="login.php" class="estilo2">Intentar de nuevo</a></h5></td>
    </tr>
  </table>
  <p>&nbsp;</p>
</div>
