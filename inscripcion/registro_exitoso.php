...
if ((isset($_GET['doLogout'])) &&($_GET['doLogout']=="true")){
  ...
  $logoutGoTo = "file:///C|/xampp/htdocs/index.php";
  if ($logoutGoTo) {
...
<div id="div_hdr_path">&nbsp;Inicio &gt; Inscripción &gt; Registro exitoso</div>
...
<div id="div_contenido">
  ...
  <table width="600" align="center" class="tabla_usuario">
    ...
    <tr>
      <td colspan="2"><div class="div_mensaje_info" align="right">Registro exitoso!!!</div></td>
    </tr>
    <tr>
      <td><img src="../imagenes/info.png" width="128" height="128" alt="Alerta" /></td>
      <td>Estas viendo este mansaje porque tu registro al sistema fue exitoso. Puedes hacer clic en alguna de las opciones del menú o iniciar sesión en el enlace de abajo.</td>
    </tr>
    <tr align="right">
      <td colspan="2"><a href="../login.php" class="estilo3">Iniciar sesión</a></td>
    </tr>
  </table>
  <p>&nbsp;</p>
</div>
