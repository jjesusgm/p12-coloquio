...
<div id="div_hdr_path">&nbsp;Inicio &gt; Inscripción &gt; Comprobante de pago</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" border="0" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Comprobante de pago</h1></td>
    </tr>
    <tr>
      <td><table width="100%">
        <tr>
          <td colspan="2">Utilice el  formulario que se encuentra en la parte de abajo para subir el comprobante de pago escaneado. El sistema siempre cambia el nombre del archivo por el nombre del usuario, la extensión se conserva, lo cual implica lo siguiente:</td>
          </tr>
        <tr>
          <td width="20" align="right">-</td>
          <td>Si el archivo ya existe y es del mismo tipo va a reemplazar al existente aunque se llamen diferente.</td>
        </tr>
        <tr>
          <td width="20" align="right">-</td>
        ...
        <tr>
          ...
          <td>Para los estudiantes y la comunidad universitaria (U de G), se pueden escanear el recibo y la identificación oficial correspondiente en el mismo PDF.</td>
        </tr>
      </table>
      ...
      <table width="100%" border="0">
        <tr>
          <td width="40">&nbsp;</td>
          <td>- Archivo PDF (recomendado)</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>- Archivo de imagen (PNG, JPG)</td>
        </tr>
      </table></td>
    </tr>
<?php
...
$files = glob("./comp_pago/".$_SESSION['MM_Username'].".*");
...
if ($num_files > 0){
	...
	foreach($files as $nombre_archivo){
		...
		echo " <- <a href='delete.php?archivo=".$nombre_archivo."' class='estilo3'>Eliminar</a>";
	}
	echo "<br><br>Estatus: ".$row_rsUsuario['comp_pago_stat'];
	echo "<br>Comentario: ".$row_rsUsuario['comentario1'];
	echo "</td></tr>";
	echo "</table>";
	echo "</td></tr>";
}
...
?>
    <tr>
      <td><h1 class="H_Estilo1">Formulario</h1></td>
    </tr>
    <tr>
      <td><form action="upload.php" method="post" enctype="multipart/form-data" name="form1">
      	<table width="100%" border="0">
      	  <tr>
      	    <td><label for="fArchivo">Archivo que se va a subir</label>
      	      <br><input type="hidden" name="MAX_FILE_SIZE" value="16000000" />
              <input name="uploadedFile" type="file" id="uploadedFile" size="50"></td>
    	    </tr>
      	  <tr>
