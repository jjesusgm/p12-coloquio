...
<div id="div_hdr_path">&nbsp;Inicio &gt; Inscripción &gt; Constancia</div>
<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Contenido" -->
<div id="div_contenido">
  <table width="90%" border="0" align="center">
    <tr>
      <td><h1 class="H_Estilo1">Descarga de constancia</h1></td>
    </tr>
    <tr>
      <td><table width="100%">
        <tr>
          <td width="20"><p class="justificado">En la tabla de abajo encontrará el enlace al archivo PDF con la constancia en formato electrónico para que en cualquier momento la pueda descargar e imprimir.</p>
            <p class="justificado">Este enlace aparecerá hasta que las constancias esten elaboradas y se suban a este servidor.</p></td>
          </tr>
      </table>
      <h3 class="H_Estilo2">Archivo de la constancia:</h3></td>
    </tr>
    <tr>
      <td>
<?php
...
// INICIO: Mostrar archivo de constancia
$files = glob("./constancias/".$_SESSION['MM_Username']."_*.*");
...
if ($num_files > 0){
	...
	echo "<th>";
	echo "</th><td>";
	echo "Aún no se ha elaborado la constancia, intente de nuevo mas adelante.";
	echo "</td></tr>";
	echo "</table>";
}
// FIN: Mostrar archivo de constancia
?>
      </td>
    </tr>
    <tr>
