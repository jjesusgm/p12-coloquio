    ...
    <tr>
      <td align="center"><form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <div class="DivShadowMsg"><table width="800" border="0" class="tabla_info_msg">
          <tr>
            <th colspan="2" align="left" scope="col">Información del asistente</th>
            </tr>
          <tr>
          ...
          <tr>
            <td align="right"><label for="fNip">Correo electrónico</label></td>
          ...
          <tr>
            ...
            <td><input name="fApePat" type="text" id="fApePat" size="30" maxlength="30" required><span class="validity"></span>
              <input name="fNivelDeAcceso" type="hidden" id="fNivelDeAcceso" value="Asistente"></td>
          </tr>
          <tr>
      ...
      <td align="center"><table width="800" border="0">
          <tr>
            <td><table class="TBL_MsgError">
              <tr>
                <th scope="row">&nbsp;</th>
                <td>NOTA: Las constancias se generarán tal como se registren los participantes. Sólo se extenderá constancia a  participantes debidamente registrados y que hayan cubierto la cuota de inscripción.</td>
              </tr>
            </table></td>
          </tr>
      </table></td>
